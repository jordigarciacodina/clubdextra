	...
	<form id="rcp_profile_editor_form" class="rcp_form" action="<?php echo rcp_get_current_url(); ?>" method="post">
		<fieldset>
			...
			<p id="rcp_profile_first_name_wrap">
				<input placeholder="<?php _e( 'First Name', 'rcp' ); ?>" name="rcp_first_name" id="rcp_first_name" class="text rcp-input" type="text" value="<?php echo esc_attr( $first_name ); ?>" />
			</p>
			...
			<p>
				<input placeholder="<?php _e( 'Email Address', 'rcp' ); ?>" name="rcp_email" id="rcp_email" class="text rcp-input required" type="email" value="<?php echo esc_attr( $current_user->user_email ); ?>" />
			</p>
        ...
        <fieldset>
			...
			<p id="rcp_profile_password_wrap">
				<input placeholder="<?php _e( 'New Password', 'rcp' ); ?>" name="rcp_new_user_pass1" id="rcp_new_user_pass1" class="password rcp-input" type="password"/>
			</p>
			<p id="rcp_profile_password_confirm_wrap">
				<input placeholder="<?php _e( 'Re-enter Password', 'rcp' ); ?>" name="rcp_new_user_pass2" id="rcp_new_user_pass2" class="password rcp-input" type="password"/>
			</p>
        </fieldset>
        <fieldset>
