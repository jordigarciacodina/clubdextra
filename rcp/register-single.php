...
<form id="rcp_registration_form" class="rcp_form" method="POST" action="<?php echo esc_url( rcp_get_current_url() ); ?>">
	...
	<fieldset class="rcp_user_fieldset">
		<p id="rcp_user_email_wrap">
			<input name="rcp_user_email" id="rcp_user_email" class="required" type="text" placeholder="Tu email" <?php if( isset( $_POST['rcp_user_email'] ) ) { echo 'value="' . esc_attr( $_POST['rcp_user_email'] ) . '"'; } ?>/>
		</p>
		<p id="rcp_user_first_wrap">
			<input name="rcp_user_first" id="rcp_user_first" type="text" placeholder="Tu nombre" <?php if( isset( $_POST['rcp_user_first'] ) ) { echo 'value="' . esc_attr( $_POST['rcp_user_first'] ) . '"'; } ?>/>
		</p>
		<p id="rcp_password_wrap">
			<input name="rcp_user_pass" id="rcp_password" class="required" placeholder="Tu contraseña" type="password"/>
		</p>
